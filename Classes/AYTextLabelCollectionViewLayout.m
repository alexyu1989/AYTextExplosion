//
//  AYTextLabelCollectionViewLayout.m
//  TextExplosion
//
...
@interface AYTextLabelCollectionViewLayout()
...
@implementation AYTextLabelCollectionViewLayout
...
- (void)setup
{
    self.itemSize = CGSizeMake(100.0f, 32.0f);
